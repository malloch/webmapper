...
[
    {angle: 0,   color: 'white', 
        items: [{name: mpr.convergent.method.sum,
            default_img_uri:mpr.convergent.icon.sum.black,
            highlight_img_uri:mpr.convergent.icon.sum.white}]},
    {angle: 90,  color: 'white', 
        items: [{name: mpr.convergent.method.average,
            default_img_uri:mpr.convergent.icon.average.black,
            highlight_img_uri:mpr.convergent.icon.average.white}]},
    {angle: 180, color: 'white', 
        items: [{name: mpr.convergent.method.default,
            default_img_uri:mpr.convergent.icon.default.black,
            highlight_img_uri:mpr.convergent.icon.default.white}]},
    {angle: 270, color: 'white', 
        items: [{name: mpr.convergent.method.product,
            default_img_uri:mpr.convergent.icon.product.black,
            highlight_img_uri:mpr.convergent.icon.product.white}]},
];
